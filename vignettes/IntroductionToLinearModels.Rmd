...
Linear models, or regression models, trace the the distribution of the dependent variable $Y$ – or some characteristic of the distribution (the mean) – as a function of the independent variables $X$.I
...
$log_2FC$ < T-statistic < sign$(log_2FC) \times$ p-value = FDR

.img-right[
![](../inst/images/ROC_CURVE_015.png)
ROC curves]
