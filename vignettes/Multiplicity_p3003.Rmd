...
Bonferroni adjustments are typically very conservative (assumes that the tests are independent - however tests are frequently correlated) and more complex methods are usually used (e.g. [multcomp](https://CRAN.R-project.org/package=multcomp)).
...
.img-right[
![](images/pValueDistribution/bimodal_pvalues-1.png)]
