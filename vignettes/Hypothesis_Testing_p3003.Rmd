...
Have a look at this for including figures.
...
.pull-right[
```{r teatasting-out, ref.label="teatasting", echo=FALSE}
```
...
```{r randomization_test, eval=FALSE, echo=TRUE, fig.width=20, fig.height=20}
...
.pull-right[
```{r randomization_test-out, ref.label="randomization_test", echo=FALSE, fig.width=20, fig.height=20}
```
]
...
.pull-left[
```{r randomization_test_ex2, eval=FALSE}
...
.pull-right[
```{r randomization_test_ex2-out, ref.label="randomization_test_ex2", echo=FALSE, fig.width=10, fig.height=10}
```
]
