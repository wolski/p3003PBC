...
- Determing null distribution is difficult
- If assumptions in parametric tests are not met null distribution is wrong
- Parametric tests do not make assumptions about the data
- there might be no non-parametric alternatives
- Understand CLT and what assymptotic properties are
- Asymptotic properties are sometimes used to derive null distributions for complex models. If that is the case and your sample sizes are small be carefull.
