...
In brief, it involves dividing this issue into</br>
smaller, more manageable, questions – for example,</br>
...
- "normalizing" data till obtaining expected output.
- tweaking thresholds till obtaining significant results.
- ?
...
- Avoid transfer of information unnecessary to perform a task,<br/>
...
__Reichenbach's common cause principle:__ 
...
- If unavoidable, randomize over <br/> 
  biological and technical co-variates. <br/> 
  e.g. sex, age, run ID.
