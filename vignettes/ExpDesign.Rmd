...
- Protein Quantification 
  - Strength of association : Control, Treatment 1 $5 \mu g$, Treatmant $10 \mu g$
  - Consistency : Different Genetic backgrounds, Control and Treatment
...
- Longitudinal study - repeated observations of the same variables (e.g., people) over short or long periods of time. They can also be structured as longitudinal randomized experiments, e.g. Mice aging.
]
...
.footnote[
Are you more inclined to examine a sample for a technical problem which <br/>
...
Do you apply _blinding_ or _randomization_ in your experiments?

- Use Random or Block Random order when processing samples. 
