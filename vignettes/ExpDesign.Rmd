...
which the effect of one causal variable on an outcome<br/>
...
.footnote[three or more variables - one coutcome variable and two or more causal variables.]
--
...
- More on sample size estimation.
- How to test Hypothesis
- How to analyse repeated measurments and different designs.
- Multiple Testing.
